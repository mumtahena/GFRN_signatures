...
par(mfrow=c(1,1),lwd=3)
boxplot(subtypes_preds$AKT~subtypes_preds$PAM50,col=c(2,4,5,5),ylab="AKT Activity",ylim=c(0,1),main="Intrinsic subtypes in association AKT Pathway")
boxplot(subtypes_preds$BAD~subtypes_preds$PAM50,col=c(2,4,5,5),ylab="BAD Activity",ylim=c(0,1),las=1,main="Intrinsic subtypes in association BAD Pathway")
boxplot(subtypes_preds$EGFR~subtypes_preds$PAM50,col=c(2,4,5,5),ylab="EGFR Activity",ylim=c(0,1),las=1,main="Intrinsic subtypes in association EGFR Pathway")
boxplot(subtypes_preds$HER2~subtypes_preds$PAM50,col=c(2,4,5,5),ylab="HER2 Activity",ylim=c(0,1),las=1,main="Intrinsic subtypes in association HER2 Pathway")
boxplot(subtypes_preds$IGF1R~subtypes_preds$PAM50,col=c(2,4,5,5),ylab="IGF1R Activity",ylim=c(0,1),las=1,main="Intrinsic subtypes in association IGF1R Pathway")
boxplot(subtypes_preds$KRASG12V~subtypes_preds$PAM50,col=c(2,4,5,5),ylab="KRAS Activity",ylim=c(0,1),las=1,main="Intrinsic subtypes in association KRAS Pathway")
boxplot(subtypes_preds$RAF1~subtypes_preds$PAM50,col=c(2,4,5,5,6),ylab="RAF1 Activity",ylim=c(0,1),las=1,main="Intrinsic subtypes in association RAF1 Pathway")
...
boxplot(pam50_com_tcga$PC1~as.matrix(pam50_com_tcga$PAM50),main="PC1 across intrinsic subtypes",cex=0.8, col="lightgrey", cex.axis=1.1,ylab="PC5 values")
boxplot(pam50_com_tcga$PC2~as.matrix(pam50_com_tcga$PAM50),main="PC2 across intrinsic subtypes",cex=0.8, col="lightgrey", cex.axis=1.1,ylab="PC5 values")
boxplot(pam50_com_tcga$PC3~as.matrix(pam50_com_tcga$PAM50),main="PC3 across intrinsic subtypes",cex=0.8, col="lightgrey", cex.axis=1.1,ylab="PC5 values")
boxplot(pam50_com_tcga$PC4~as.matrix(pam50_com_tcga$PAM50),main="PC4 across intrinsic subtypes",cex=0.8, col="lightgrey", cex.axis=1.1,ylab="PC5 values")
