...
kmeans.4.clusters.tcga[kmeans.4.clusters.tcga$kmeans.4.cluster == "3",] <- "AKT/HER2 high"
kmeans.4.clusters.tcga[kmeans.4.clusters.tcga$kmeans.4.cluster == "1",] <- "AKT/HER2 low"
kmeans.4.clusters.tcga[kmeans.4.clusters.tcga$kmeans.4.cluster == "2",] <- "EGFR/BAD low"
kmeans.4.clusters.tcga[kmeans.4.clusters.tcga$kmeans.4.cluster == "4",] <- "EGFR/BAD high"
...
h1 <- Heatmap(scale(single_pathway_best_tcga[,c(1:4)]), cluster_rows = T, cluster_columns = T,
              ...
              split=factor(kmeans.4.clusters.tcga$KMeans.Clusters,
                           levels=c("AKT/HER2 high","AKT/HER2 low","EGFR/BAD high","EGFR/BAD low")),
