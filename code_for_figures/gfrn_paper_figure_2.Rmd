...
create_figure2_a_TCGA_allpath <- function(expression_subtypes_df, showLegends=TRUE){
  set.seed(123)
...
```{r echo=FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height=7}
create_figure2_b_ICBP_allpath <- function(expression_subtypes_df, showLegends=TRUE){
  set.seed(123)
  phenotype.annotation <- data.frame(Phenotype=c("Survival Phenotype",
                                                 "Growth Phenotype",
                                                 "Growth Phenotype",
