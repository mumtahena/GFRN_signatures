...
## Without Removing "Unknown" samples in any category, n=1119

```{r echo=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
firstfive_TCGA <- data.frame(pca_mat$x[,1:5])
firstfive_TCGA <- firstfive_TCGA[rownames(single_pathway_best_tcga),]
firstfive_TCGA <- cbind(firstfive_TCGA, single_pathway_best_tcga[,8:13])
all_samples_n1119 <- run_all_lms(firstfive_TCGA)
all_samples_n1119_result <- data.frame(R2=unlist(lapply(all_samples_n1119, function(x) summary(x)$r.squared)), p=unlist(lapply(all_samples_n1119, function(x) summary(x)$r.squared)))

result_df_ER <- data.frame(
PC=c(1:5),

ER=c(all_samples_n1119_result[32,1], #ER PC1
  all_samples_n1119_result[95,1], #ER PC2
  all_samples_n1119_result[158,1], #ER PC3
  all_samples_n1119_result[221,1], #ER PC4
  all_samples_n1119_result[284,1]), #ER PC5

ER.kmeans=c(all_samples_n1119_result[33,1], #ER + kmeans PC1
  all_samples_n1119_result[96,1], #ER + kmeans PC2
  all_samples_n1119_result[159,1], #ER + kmeans PC3
  all_samples_n1119_result[222,1], #ER + kmeans PC4
  all_samples_n1119_result[285,1]), #ER + kmeans PC5

ER.kmeans.pval=c(anova(all_samples_n1119[[32]], all_samples_n1119[[33]])[6][2,1], #ER + kmeans PC1
  anova(all_samples_n1119[[95]], all_samples_n1119[[96]])[6][2,1], #ER + kmeans PC2
  anova(all_samples_n1119[[158]], all_samples_n1119[[159]])[6][2,1], #ER + kmeans PC3
  anova(all_samples_n1119[[221]], all_samples_n1119[[222]])[6][2,1], #ER + kmeans PC4
  anova(all_samples_n1119[[284]], all_samples_n1119[[285]])[6][2,1]), #ER + kmeans PC5

ER.PAM50=c(all_samples_n1119_result[33+3,1], #ER + PAM50 PC1
  all_samples_n1119_result[96+3,1], #ER + PAM50 PC2
  all_samples_n1119_result[159+3,1], #ER + PAM50 PC3
  all_samples_n1119_result[222+3,1], #ER + PAM50 PC4
  all_samples_n1119_result[285+3,1]), #ER + PAM50 PC5

ER.PAM50.pval=c(anova(all_samples_n1119[[32]], all_samples_n1119[[33+3]])[6][2,1], #ER + PAM50 PC1
  anova(all_samples_n1119[[95]], all_samples_n1119[[96+3]])[6][2,1], #ER + PAM50 PC2
  anova(all_samples_n1119[[158]], all_samples_n1119[[159+3]])[6][2,1], #ER + PAM50 PC3
  anova(all_samples_n1119[[221]], all_samples_n1119[[222+3]])[6][2,1], #ER + PAM50 PC4
  anova(all_samples_n1119[[284]], all_samples_n1119[[285+3]])[6][2,1]), #ER + PAM50 PC5

ER.phenotype=c(all_samples_n1119_result[33+1,1], #ER + GFRN Pheno PC1
  all_samples_n1119_result[96+1,1], #ER + GFRN Pheno PC2
  all_samples_n1119_result[159+1,1], #ER + GFRN Pheno PC3
  all_samples_n1119_result[222+1,1], #ER + GFRN Pheno PC4
  all_samples_n1119_result[285+1,1]), #ER + GFRN Pheno PC5

ER.phenotype.pval=c(anova(all_samples_n1119[[32]], all_samples_n1119[[33+1]])[6][2,1], #ER + GFRN Pheno PC1
  anova(all_samples_n1119[[95]], all_samples_n1119[[96+1]])[6][2,1], #ER + GFRN Pheno PC2
  anova(all_samples_n1119[[158]], all_samples_n1119[[159+1]])[6][2,1], #ER + GFRN Pheno PC3
  anova(all_samples_n1119[[221]], all_samples_n1119[[222+1]])[6][2,1], #ER + GFRN Pheno PC4
  anova(all_samples_n1119[[284]], all_samples_n1119[[285+1]])[6][2,1]) #ER + GFRN Pheno PC5
)

result_df_PR <- data.frame(
PC=c(1:5),

PR=c(all_samples_n1119_result[16,1], #PR PC1
  all_samples_n1119_result[79,1], #PR PC2
  all_samples_n1119_result[142,1], #PR PC3
  all_samples_n1119_result[205,1], #PR PC4
  all_samples_n1119_result[268,1]), #PR PC5

PR.kmeans=c(all_samples_n1119_result[17,1], #PR + kmeans PC1
  all_samples_n1119_result[80,1], #PR + kmeans PC2
  all_samples_n1119_result[143,1], #PR + kmeans PC3
  all_samples_n1119_result[206,1], #PR + kmeans PC4
  all_samples_n1119_result[269,1]), #PR + kmeans PC5

PR.kmeans.pval=c(anova(all_samples_n1119[[16]], all_samples_n1119[[17]])[6][2,1], #PR + kmeans PC1
  anova(all_samples_n1119[[79]], all_samples_n1119[[80]])[6][2,1], #PR + kmeans PC2
  anova(all_samples_n1119[[142]], all_samples_n1119[[143]])[6][2,1], #PR + kmeans PC3
  anova(all_samples_n1119[[205]], all_samples_n1119[[206]])[6][2,1], #PR + kmeans PC4
  anova(all_samples_n1119[[268]], all_samples_n1119[[269]])[6][2,1]), #PR + kmeans PC5

PR.PAM50=c(all_samples_n1119_result[17+3,1], #PR + PAM50 PC1
  all_samples_n1119_result[80+3,1], #PR + PAM50 PC2
  all_samples_n1119_result[143+3,1], #PR + PAM50 PC3
  all_samples_n1119_result[206+3,1], #PR + PAM50 PC4
  all_samples_n1119_result[269+3,1]), #PR + PAM50 PC5

PR.PAM50.pval=c(anova(all_samples_n1119[[16]], all_samples_n1119[[17+3]])[6][2,1], #PR + PAM50 PC1
  anova(all_samples_n1119[[79]], all_samples_n1119[[80+3]])[6][2,1], #PR + PAM50 PC2
  anova(all_samples_n1119[[142]], all_samples_n1119[[143+3]])[6][2,1], #PR + PAM50 PC3
  anova(all_samples_n1119[[205]], all_samples_n1119[[206+3]])[6][2,1], #PR + PAM50 PC4
  anova(all_samples_n1119[[268]], all_samples_n1119[[269+3]])[6][2,1]), #PR + PAM50 PC5


PR.phenotype=c(all_samples_n1119_result[17+1,1], #PR + GFRN Pheno PC1
  all_samples_n1119_result[80+1,1], #PR + GFRN Pheno PC2
  all_samples_n1119_result[143+1,1], #PR + GFRN Pheno PC3
  all_samples_n1119_result[206+1,1], #PR + GFRN Pheno PC4
  all_samples_n1119_result[269+1,1]), #PR + GFRN Pheno PC5

PR.phenotype.pval=c(anova(all_samples_n1119[[16]], all_samples_n1119[[17+1]])[6][2,1], #PR + GFRN Pheno PC1
  anova(all_samples_n1119[[79]], all_samples_n1119[[80+1]])[6][2,1], #PR + GFRN Pheno PC2
  anova(all_samples_n1119[[142]], all_samples_n1119[[143+1]])[6][2,1], #PR + GFRN Pheno PC3
  anova(all_samples_n1119[[205]], all_samples_n1119[[206+1]])[6][2,1], #PR + GFRN Pheno PC4
  anova(all_samples_n1119[[268]], all_samples_n1119[[269+1]])[6][2,1]) #PR + GFRN Pheno PC5
)

result_df_HER2 <- data.frame(
PC=c(1:5),

HER2=c(all_samples_n1119_result[8,1], #HER2 PC1
  all_samples_n1119_result[71,1], #HER2 PC2
  all_samples_n1119_result[134,1], #HER2 PC3
  all_samples_n1119_result[197,1], #HER2 PC4
  all_samples_n1119_result[260,1]), #HER2 PC5

HER2.kmeans=c(all_samples_n1119_result[9,1], #HER2 + kmeans PC1
  all_samples_n1119_result[72,1], #HER2 + kmeans PC2
  all_samples_n1119_result[135,1], #HER2 + kmeans PC3
  all_samples_n1119_result[198,1], #HER2 + kmeans PC4
  all_samples_n1119_result[261,1]), #HER2 + kmeans PC5

HER2.kmeans.pval=c(anova(all_samples_n1119[[8]], all_samples_n1119[[9]])[6][2,1], #HER2 + kmeans PC1
  anova(all_samples_n1119[[71]], all_samples_n1119[[72]])[6][2,1], #HER2 + kmeans PC2
  anova(all_samples_n1119[[134]], all_samples_n1119[[135]])[6][2,1], #HER2 + kmeans PC3
  anova(all_samples_n1119[[197]], all_samples_n1119[[198]])[6][2,1], #HER2 + kmeans PC4
  anova(all_samples_n1119[[260]], all_samples_n1119[[261]])[6][2,1]), #HER2 + kmeans PC5

HER2.PAM50=c(all_samples_n1119_result[9+3,1], #HER2 + PAM50 PC1
  all_samples_n1119_result[72+3,1], #HER2 + PAM50 PC2
  all_samples_n1119_result[135+3,1], #HER2 + PAM50 PC3
  all_samples_n1119_result[198+3,1], #HER2 + PAM50 PC4
  all_samples_n1119_result[261+3,1]), #HER2 + PAM50 PC5

HER2.PAM50.pval=c(anova(all_samples_n1119[[8]], all_samples_n1119[[9+3]])[6][2,1], #HER2 + PAM50 PC1
  anova(all_samples_n1119[[71]], all_samples_n1119[[72+3]])[6][2,1], #HER2 + PAM50 PC2
  anova(all_samples_n1119[[134]], all_samples_n1119[[135+3]])[6][2,1], #HER2 + PAM50 PC3
  anova(all_samples_n1119[[197]], all_samples_n1119[[198+3]])[6][2,1], #HER2 + PAM50 PC4
  anova(all_samples_n1119[[260]], all_samples_n1119[[261+3]])[6][2,1]), #HER2 + PAM50 PC5

HER2.phenotype=c(all_samples_n1119_result[9+1,1], #HER2 + GFRN Pheno PC1
  all_samples_n1119_result[72+1,1], #HER2 + GFRN Pheno PC2
  all_samples_n1119_result[135+1,1], #HER2 + GFRN Pheno PC3
  all_samples_n1119_result[198+1,1], #HER2 + GFRN Pheno PC4
  all_samples_n1119_result[261+1,1]), #HER2 + GFRN Pheno PC5

HER2.phenotype.pval=c(anova(all_samples_n1119[[8]], all_samples_n1119[[9+1]])[6][2,1], #HER2 + GFRN Pheno PC1
  anova(all_samples_n1119[[71]], all_samples_n1119[[72+1]])[6][2,1], #HER2 + GFRN Pheno PC2
  anova(all_samples_n1119[[134]], all_samples_n1119[[135+1]])[6][2,1], #HER2 + GFRN Pheno PC3
  anova(all_samples_n1119[[197]], all_samples_n1119[[198+1]])[6][2,1], #HER2 + GFRN Pheno PC4
  anova(all_samples_n1119[[260]], all_samples_n1119[[261+1]])[6][2,1]) #HER2 + GFRN Pheno PC5
)

result_df_all3 <- data.frame(
PC=c(1:5),

ER.PR.HER2=c(all_samples_n1119_result[56,1], #ER/PR/HER2 PC1
  all_samples_n1119_result[119,1], #ER/PR/HER2 PC2
  all_samples_n1119_result[182,1], #ER/PR/HER2 PC3
  all_samples_n1119_result[245,1], #ER/PR/HER2 PC4
  all_samples_n1119_result[308,1]), #ER/PR/HER2 PC5

ER.PR.HER2.kmeans=c(all_samples_n1119_result[57,1], #ER/PR/HER2 + kmeans PC1
  all_samples_n1119_result[120,1], #ER/PR/HER2 + kmeans PC2
  all_samples_n1119_result[183,1], #ER/PR/HER2 + kmeans PC3
  all_samples_n1119_result[246,1], #ER/PR/HER2 + kmeans PC4
  all_samples_n1119_result[309,1]), #ER/PR/HER2 + kmeans PC5

ER.PR.HER2.kmeans.pval=c(anova(all_samples_n1119[[56]], all_samples_n1119[[57]])[6][2,1], #ER.PR.HER2 + kmeans PC1
  anova(all_samples_n1119[[119]], all_samples_n1119[[120]])[6][2,1], #ER.PR.HER2 + kmeans PC2
  anova(all_samples_n1119[[182]], all_samples_n1119[[183]])[6][2,1], #ER.PR.HER2 + kmeans PC3
  anova(all_samples_n1119[[245]], all_samples_n1119[[246]])[6][2,1], #ER.PR.HER2 + kmeans PC4
  anova(all_samples_n1119[[308]], all_samples_n1119[[309]])[6][2,1]), #ER.PR.HER2 + kmeans PC5

ER.PR.HER2.PAM50=c(all_samples_n1119_result[57+3,1], #ER/PR/HER2 + PAM50 PC1
  all_samples_n1119_result[120+3,1], #ER/PR/HER2 + PAM50 PC2
  all_samples_n1119_result[183+3,1], #ER/PR/HER2 + PAM50 PC3
  all_samples_n1119_result[246+3,1], #ER/PR/HER2 + PAM50 PC4
  all_samples_n1119_result[309+3,1]), #ER/PR/HER2 + PAM50 PC5

ER.PR.HER2.PAM50.pval=c(anova(all_samples_n1119[[56]], all_samples_n1119[[57+3]])[6][2,1], #ER.PR.HER2 + PAM50 PC1
  anova(all_samples_n1119[[119]], all_samples_n1119[[120+3]])[6][2,1], #ER.PR.HER2 + PAM50 PC2
  anova(all_samples_n1119[[182]], all_samples_n1119[[183+3]])[6][2,1], #ER.PR.HER2 + PAM50 PC3
  anova(all_samples_n1119[[245]], all_samples_n1119[[246+3]])[6][2,1], #ER.PR.HER2 + PAM50 PC4
  anova(all_samples_n1119[[308]], all_samples_n1119[[309+3]])[6][2,1]), #ER.PR.HER2 + PAM50 PC5

ER.PR.HER2.phenotype=c(all_samples_n1119_result[57+1,1], #ER/PR/HER2 + GFRN Pheno PC1
  all_samples_n1119_result[120+1,1], #ER/PR/HER2 + GFRN Pheno PC2
  all_samples_n1119_result[183+1,1], #ER/PR/HER2 + GFRN Pheno PC3
  all_samples_n1119_result[246+1,1], #ER/PR/HER2 + GFRN Pheno PC4
  all_samples_n1119_result[309+1,1]), #ER/PR/HER2 + GFRN Pheno PC5

ER.PR.HER2.phenotype.pval=c(anova(all_samples_n1119[[56]], all_samples_n1119[[57+1]])[6][2,1], #ER.PR.HER2 + GFRN Pheno PC1
  anova(all_samples_n1119[[119]], all_samples_n1119[[120+1]])[6][2,1], #ER.PR.HER2 + GFRN Pheno PC2
  anova(all_samples_n1119[[182]], all_samples_n1119[[183+1]])[6][2,1], #ER.PR.HER2 + GFRN Pheno PC3
  anova(all_samples_n1119[[245]], all_samples_n1119[[246+1]])[6][2,1], #ER.PR.HER2 + GFRN Pheno PC4
  anova(all_samples_n1119[[308]], all_samples_n1119[[309+1]])[6][2,1]) #ER.PR.HER2 + GFRN Pheno PC5
)
kable(result_df_ER)
kable(result_df_PR)
...
## PCA After Removing "Unknown" samples in any category, n=355

```{r  echo=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
pca_mat_reduced <- prcomp(t(tcga_expression[,rownames(single_pathway_best_tcga_noNA)]), center=T,scale=T)
cum_tcga<-cumsum((pca_mat_reduced$sdev)^2) / sum(pca_mat_reduced$sdev^2) #calculates cumulative proportiono of variances
firstfive_TCGA_reduced <- data.frame(pca_mat_reduced$x[,1:5])
firstfive_TCGA_reduced <- firstfive_TCGA_reduced[rownames(single_pathway_best_tcga_noNA),]
firstfive_TCGA_reduced <- cbind(firstfive_TCGA_reduced, single_pathway_best_tcga_noNA[,8:13])
unknown_remove_all <- run_all_lms(firstfive_TCGA_reduced)
unknown_remove_all_result <- data.frame(R2=unlist(lapply(unknown_remove_all, function(x) summary(x)$r.squared)), p=unlist(lapply(unknown_remove_all, function(x) summary(x)$r.squared)))
