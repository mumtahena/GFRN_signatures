...
#REMOVE KRAS (SHELLEY ADDED THIS, 7Nov16)
single_pathway_best_icbp = single_pathway_best_icbp[,-7]
...
#REMOVE KRAS (SHELLEY ADDED THIS, 7Nov16)
single_pathway_best_tcga = single_pathway_best_tcga[,-7]
...
heatmap.2(as.matrix(scale(single_pathway_best_icbp[selected_celllines,c(1:7)])),col=my_palette,trace="none",margins=c(7,7),main="",ColSideColors = c("coral3","aquamarine4","aquamarine4","coral3","coral3","aquamarine4","aquamarine4"), key.title="",scale="row", key=F)#,Rowv=F,Colv=F)
...
single_pathway_best_icbp_scaled[,c(2,3,6,7)]
